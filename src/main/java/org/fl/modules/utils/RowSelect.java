...
/**
 * <p> Used to figure out the row information so the proper page of information can be retrieved. </p>
 *
...
public class RowSelect implements Serializable {
	...
	/**
	 * Testing that the page returned is not greater than the pages that are able to be displayed. The problem arises if
	 * using the state feature and rows are deleted.
	 *
	 * @param page the page
	 * @param maxRows the max rows
	 * @param totalRows the total rows
