package org.fl.modules.excel.poi.annotation;
...
public @interface Excel {
	...
	/**
	 * 若是sign为1,则需要在pojo中加入一个方法 convertGet字段名() 例如，字段sex ，需要加入 public String convertGet字段名() 返回值为string 若是sign为0,则不转换
	 * 建议使用
	 * @Transient 这个注解让hibernate忽略这个方法
	 */
	public int exportConvertSign() default 0;

	/**
	 * 导入数据是否需要转化 及 对已有的excel，是否需要将字段转为对应的数据 若是sign为1,则需要在pojo中加入 void convertSet字段名(String text)
	 */
	...
	/**
	 * 方法描述: 数据字典表 日 期： 2014年5月11日-下午5:26:40
	 *
	 * @return 返回类型： String
	 */
	...
	/**
	 * 方法描述: 数据code 日 期： 2014年5月13日-下午9:37:16
	 *
	 * @return 返回类型： String
	 */
	...
	/**
	 * 方法描述: 数据Text 日 期： 2014年5月11日-下午5:29:05
	 *
	 * @return 返回类型： String
	 */
